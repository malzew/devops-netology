...
*Инфраструктура была поднята в Яндекс Облаке. 3 виртуальные машины - teamcity server, teamcity agent и репозиторий nexus3.*
...
[Репозиторий](https://github.com/malzew/example-teamcity)
