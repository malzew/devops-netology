...
*Выполнено. access_key и secret_key передаются через переменные окружения AWS_ACCESS_KEY_ID и AWS_SECRET_ACCESS_KEY соответственно.*
...
data.yandex_client_config.client: Read complete after 1s [id=4236583514]
data.yandex_compute_image.ubuntu: Read complete after 1s [id=fd8ju9iqf6g5bcq77jns]
